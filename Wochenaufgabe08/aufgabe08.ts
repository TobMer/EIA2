namespace l08aufgabe {  // ich habe mein bestes getan und hab ewig gebraucht. Zwar kam des etwas spät aber über ein Feedback freue ich mich
    ...
    function zeichneSonne(_position): void {
    ...
    function zeichneSchneemann(_position: Vector, _position2: Vector): void {
    ...
    function zeichneHut(_position: Vector, _position2: Vector) {
